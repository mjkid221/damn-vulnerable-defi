...
describe("[Challenge] The rewarder", function () {
  ...
  /**
   * The rewarder pool contract has a vulnerability in the way it calculates
   * the rewards for each depositor. The rewarder pool contract uses a
   * snapshot of the accounting token balance to calculate the rewards for
   * each depositor. The attacker can exploit this by flashloaning a large
   * amount of tokens from the flashloan pool and depositing them into the
   * rewarder pool just before the next snapshot is taken. The attacker can
   * then withdraw the tokens from the rewarder pool and repay the flashloan.
   */
